...
- Parse command line arguments and provide description of each argument.
...
- Replace **#TODO Importing required packages**, with the following lines of code
...
- Replace **#TODO Defining build_argparser method**, with the following lines of code
...
### 3. Defining the function to Load Pre-trained Optimized Data Model for inferencing.
...
- Replace **#TODO Defining Load Model**, with the following lines of code
...
- Replace **#TODO Face_Detection 1**, with the following lines of code
...
- Replace **#TODO Face_Detection 2**, with the following lines of code
...
- Replace **#TODO Face_Detection 3**, with the following lines of code
...
- Replace **#TODO Face_Detection 4**, with the following lines of code
